...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="max-w-[1720px] 2xl:max-w-[1880px] 3xl:max-w-[2200px] 4xl:max-w-[2600px] mx-auto px-4 sm:px-8 lg:px-12 3xl:px-16 my-6">
      <div className="p-4 sm:p-5 rounded-xl bg-[#181818]/90 border border-white/10 backdrop-blur-xl space-y-4 shadow-xl shadow-black/40">
        {/* Top Type Tabs */}
        <div className="flex items-center justify-between gap-4 overflow-x-auto no-scrollbar pb-1">
          ...
          {hasActiveFilters && (
            <button
              ...
              onMouseEnter={playHover}
              className="flex items-center gap-1.5 text-xs text-red-400 hover:text-white font-medium whitespace-nowrap px-3.5 py-1.5 rounded-full bg-[#E50914]/15 hover:bg-[#E50914] border border-[#E50914]/30 transition-all duration-200"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3 border-t border-white/[0.08]">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full bg-[#141414] border border-white/15 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-[#E50914] hover:border-white/30 cursor-pointer transition-colors"
            >
              {GENRE_LIST.map((g) => (
