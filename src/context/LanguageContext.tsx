...
export const translations = {
  id: {
    ...
    guideAnimeServerNotice: 'Khusus tayangan anime, Server 3 (2Embed) & Server 5 (Smashy) memutar Audio Asli Jepang. Pada player dual-audio, ubah track suara lewat ikon gerigi ⚙️ player.',
    guideIndoServerNotice: 'Khusus film & serial Indonesia, pemutar secara otomatis memprioritaskan Server 5 (SmashyStream Multi-Host) untuk stabilitas tayangan lokal terbaik.',
  ...
  en: {
    ...
    guideAnimeServerNotice: 'For anime, Server 3 (2Embed) & Server 5 (Smashy) stream Original Japanese Audio. On dual-audio players, switch audio track via player settings ⚙️.',
    guideIndoServerNotice: 'For Indonesian movies & series, the player automatically prioritizes Server 5 (SmashyStream Multi-Host) for the best local streaming stability.',
