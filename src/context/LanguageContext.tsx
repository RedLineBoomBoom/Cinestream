...
export const translations = {
  id: {
    ...
    guideIndoServerNotice: 'Khusus film & serial Indonesia, pemutar secara otomatis memprioritaskan Server 2 (AutoEmbed Ultra) & Server 1 (VidSrc) untuk kelancaran anti-macet tanpa buffering.',
  ...
  en: {
    ...
    guideIndoServerNotice: 'For Indonesian movies & series, the player automatically prioritizes Server 2 (AutoEmbed Ultra) & Server 1 (VidSrc) for smooth, buffer-free HD playback.',
