...
export const translations = {
  id: {
    ...
    guide: 'Panduan',
    guideServerNotice: 'Tersedia 6 server streaming independen. Jika server mengalami kendala atau 404, silakan beralih ke Server 1 (VidSrc Prime), Server 4 (MultiStream), atau Server 5 (SmashyStream).',
    ...
    guideIndoServerNotice: 'Khusus film & serial Indonesia, pemutar mengandalkan Server 5 (SmashyStream: Sub Indo). Jika loading lama di browser PC, klik "Tap to continue" di player, matikan sejenak AdBlocker/Brave Shields, atau beralih ke Server 1 / 4 via tombol ⚡ Ganti Server.',
  ...
  en: {
    ...
    guide: 'Guide',
    guideServerNotice: '6 independent streaming servers available. If a server has issues or shows 404, switch to Server 1 (VidSrc Prime), Server 4 (MultiStream), or Server 5 (SmashyStream).',
    ...
    guideIndoServerNotice: 'For Indonesian movies & series, the player prioritizes Server 5 (SmashyStream: Sub Indo). If loading spins on PC browser, click "Tap to continue", temporarily pause AdBlocker/Brave Shields, or switch to Server 1 / 4 via ⚡ Switch Server.',
