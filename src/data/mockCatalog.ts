...
export const createMovieServers = (tmdbId: number, _fallbackUrl?: string) => [
  ...
  {
    id: 'srv-smashy',
    name: 'Server 5 • SmashyStream (Sub Indo Multi-Host)',
    speed: '14 ms',
    quality: '1080p FHD',
...
export const createTvServers = (
  ...
  },
  {
    ...
    name: 'Server 5 • SmashyStream TV (Sub Indo Multi-Host)',
    speed: '14 ms',
    quality: '1080p FHD',
    url: `https://embed.smashystream.com/playere.php?tmdb=${tmdbId}&season=${seasonNumber}&episode=${episodeNumber}`,
    status: 'online' as const,
    isEmbed: true,
  },
  {
