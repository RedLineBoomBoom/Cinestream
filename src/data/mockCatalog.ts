...
export const createMovieServers = (tmdbId: number, _fallbackUrl?: string) => [
  ...
  {
    id: 'srv-smashy',
    name: 'Server 5 • AnyEmbed (Sub Indo Multi-Host)',
    speed: '14 ms',
    quality: '1080p FHD',
    url: `https://anyembed.xyz/embed/tmdb-movie-${tmdbId}`,
    status: 'online' as const,
    isEmbed: true,
  },
  {
...
export const createTvServers = (
  ...
  {
    id: `srv-smashy-s${seasonNumber}e${episodeNumber}`,
    name: 'Server 5 • AnyEmbed TV (Sub Indo Multi-Host)',
    speed: '14 ms',
    quality: '1080p FHD',
    url: `https://anyembed.xyz/embed/tmdb-tv-${tmdbId}-${seasonNumber}-${episodeNumber}`,
    status: 'online' as const,
    isEmbed: true,
  },
  {
